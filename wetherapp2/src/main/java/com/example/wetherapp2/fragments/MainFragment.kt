...
import com.example.wetherapp2.DialogManager
import com.example.wetherapp2.MainViewModel
import com.example.wetherapp2.R
import com.example.wetherapp2.adapters.VpAdapter
...
class MainFragment : Fragment() {
    ...
    private fun checkLocation(){
        if(isLocationEnabled()){
            ...
            DialogManager.lactionSettingDialog(requireContext(), object : DialogManager.Listener{
                override fun onClick(name: String?) {
    ...
    private fun updateCurrentCard() = with(binding){
        model.liveDataCurrent.observe(viewLifecycleOwner){
            ...
            Picasso.get().load("https:" + it.imageUrl).into(imWhether)
